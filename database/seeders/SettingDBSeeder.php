...
class SettingDBSeeder extends Seeder
{
    ...
    {
        Setting::create([
           'website_name'=>["ar"=>"Feleceazzuraa Arabic","en"=>"Feleceazzuraa"],
            'website_bio'=>["ar"=>"شركة متحصصة في البيع منتجاتFeleceazzuraa  ","en"=>"Compony "],
           'address'=>["ar"=>"فلسطين عزة","en"=>"Gaza Palstine"],
