...
class CategoryDBSeed extends Seeder
{
    ...
    public function run()
    {
        $array=[
            [
            'title'=>["ar"=>"عطري بشرتك","en"=>"Perfumes your skin"]
            ,"slug"=>["ar"=>"عطري-بشرتك","en"=>"perfumes-your-skin"],
            ...
            [
                'title'=>["ar"=>"عطري غسيلك","en"=>"Perfumes your laundry"]
                ,"slug"=>["ar"=>"عطري-بشرتك","en"=>"perfumes-your-laundry"],
            ...
            [
                'title'=>["ar"=>"عطري منزلك","en"=>"Perfumes your home"]
                ,"slug"=>["ar"=>"عطري-منزلك","en"=>"perfumes-your-home"],
