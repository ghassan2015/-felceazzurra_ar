            ...
            <form name='my-form' id="my-form"action="javascript:void(0)" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-12 col-lg-6 p-2">
                        ...
                        <div class="col-12 pt-3">
                            <input type="text" name="title_en" required class="form-control" id="title_en"
                                   placeholder="@lang('admin.title_en')"  value="{{old('title_en')}}">
                            <div class="invalid-feedback">
                                العنوان باللغة الانجليزية
                            </div>
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-12 col-lg-6 p-2">
                        ...
                        <div class="editor  col-12 pt-3">
                            <textarea class="form-control  description_editor" required id="description_en" name="description_en"></textarea>
                        </div>
